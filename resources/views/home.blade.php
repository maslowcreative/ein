        ...
        <div class="modal-body addUser">
          <div class="row">
            ...
            <div class="col-md-6">
              {{-- Step 1 --}}
              <div class="step1">
                <h6>Choose your User Type</h6>
                <div class="d-grid gap-2">
                  <div>
                    <input type="checkbox" class="btn-check" id="btn-check-1" autocomplete="off">
                    <label class="btn btn-light d-block" for="btn-check-1">Provider</label>
                  </div>
                  <div>
                    <input type="checkbox" class="btn-check" id="btn-check-2" autocomplete="off">
                    <label class="btn btn-light d-block" for="btn-check-2">Participant</label>
                  </div>
                  <div>
                    <input type="checkbox" class="btn-check" id="btn-check-3" autocomplete="off">
                    <label class="btn btn-light d-block" for="btn-check-3">Representative</label>
                  </div>
                </div>
              </div>
              {{-- Step 2 --}}
                  ...
                  <div class="col-md-6">
                    ...
                    <div>
                      <div class="bg-light d-flex align-items-center p-3">
                        <div><img src="/images/avatar.png" width="40" alt=""></div>
                        <div class="flex-1">
                          <h6>Users Name </h6>
            ...
            10000 State, Country."></textarea>
              ...
              <div>
                <div>
                  <div class="mb-3">
                    <label for="abnNumber" class="form-label">ABN</label>
                    <input type="tel" class="form-control" id="abnNumber" placeholder="00000000000000000000">
                  </div>
                  <div class="mb-3">
                    <label for="specificItemNumbers" class="form-label">Specific Item Numbers</label>
