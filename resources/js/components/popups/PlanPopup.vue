        ...
        <div v-if="plan" class="modal-body">
          ...
          <div id="editBudgetOption" class="col-md-12 collapse">
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-4">
                            <a v-on:click="openBudegtAllocationPopup('Assistance with Daily Life',form.budgets.cat_1)"><label class="form-label">Assistance with Daily Life</label></a>
                    ...
                    <div class="col-md-6">
                        <div class="mb-4">
                            <a v-on:click="openBudegtAllocationPopup('Transport',form.budgets.cat_2)" ><label class="form-label">Transport</label></a>
                    ...
                    <div class="col-md-6">
                        <div class="mb-4">
                            <a v-on:click="openBudegtAllocationPopup('Consumables',form.budgets.cat_3)" ><label class="form-label">Consumables</label></a>
                    ...
                    <div class="col-md-6">
                        <div class="mb-4">
                            <a v-on:click="openBudegtAllocationPopup('Assistance with Social',form.budgets.cat_4)" > <label class="form-label">Assistance with Social</label></a>
                    ...
                    <div class="col-md-6">
                        <div class="mb-4">
                            <a v-on:click="openBudegtAllocationPopup('Assistive Technology',form.budgets.cat_5)" > <label class="form-label">Assistive Technology</label></a>
                    ...
                    <div class="col-md-6">
                        <div class="mb-4">
                            <a v-on:click="openBudegtAllocationPopup('Home Modifications',form.budgets.cat_6)" ><label class="form-label">Home Modifications</label></a>
                    ...
                    <div class="col-md-6">
                        <div class="mb-4">
                            <a v-on:click="openBudegtAllocationPopup('Support Coordination',form.budgets.cat_7)" ><label class="form-label">Support Coordination</label></a>
                    ...
                    <div class="col-md-6">
                        <div class="mb-4">
                            <a v-on:click="openBudegtAllocationPopup('Improved Living Arrangements',form.budgets.cat_8)" ><label class="form-label">Improved Living Arrangements</label></a>
                    ...
                    <div class="col-md-6">
                        <div class="mb-4">
                            <a v-on:click="openBudegtAllocationPopup('Increased Social',form.budgets.cat_9)" ><label class="form-label">Increased Social</label></a>
                    ...
                    <div class="col-md-6">
                        <div class="mb-4">
                            <a v-on:click="openBudegtAllocationPopup('Finding and Keeping a Job',form.budgets.cat_10)" ><label class="form-label">Finding and Keeping a Job</label></a>
                    ...
                    <div class="col-md-6">
                        <div class="mb-4">
                            <a v-on:click="openBudegtAllocationPopup('Improved Relationships',form.budgets.cat_11)" ><label class="form-label">Improved Relationships</label></a>
                    ...
                    <div class="col-md-6">
                        <div class="mb-4">
                            <a v-on:click="openBudegtAllocationPopup('Improved Health and Wellbeing',form.budgets.cat_12)" ><label class="form-label">Improved Health and Wellbeing</label></a>
                    ...
                    <div class="col-md-6">
                        <div class="mb-4">
                            <a v-on:click="openBudegtAllocationPopup('Improved Learning',form.budgets.cat_13)" ><label class="form-label">Improved Learning</label></a>
                    ...
                    <div class="col-md-6">
                        <div class="mb-4">
                            <a v-on:click="openBudegtAllocationPopup('Improved Life Choices',form.budgets.cat_14)" ><label class="form-label">Improved Life Choices</label></a>
                    ...
                    <div class="col-md-6">
                        <div class="mb-4">
                            <a v-on:click="openBudegtAllocationPopup('Improved Daily Living Skills',form.budgets.cat_15)" ><label class="form-label">Improved Daily Living Skills</label></a>
...
export default {
  ...
  methods: {
    ...
    openBudegtAllocationPopup(catName,catBudget){
        let data = {};
        data.user = this.user;
        data.plan = this.plan;
        data.form = this.form;
