                            ...
                            <div class="row">
                                <div class="col-md-6 col-xl-12">
                                    <div class="mb-4">
                                        ...
                                        <input type="date" :value="claim.start_date" class="form-control" placeholder="01/01/2021">
                                    </div>
                                </div>
                                <div class="col-md-6 col-xl-12">
                                    <div class="mb-4">
                                        <label class="form-label">End Date</label>
                                        <input type="date" :value="claim.end_date"  class="form-control" placeholder="01/01/2021">
                                    </div>
                                </div>
                                <div class="col-md-6 col-xl-12">
                                    <div class="mb-4">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="mb-4">
                                            ...
                                            <input type="text" :value="item.claim_type" class="form-control" placeholder="Standard">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="mb-4">
                                            <label class="form-label">Item Number</label>
                                            <input type="text" :value="item.support_item_number" class="form-control" placeholder="134134134134">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                        ...
                                        <div class="row g-3">
                                            <div class="col-sm-8">
                                                <div class="mb-4">
                                                    ...
                                                    <input type="text" class="form-control" :value="item.hours" placeholder="0.5">
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                <div class="mb-4">
                                                    <label class="form-label">Cost</label>
                                                    <input type="text" :value="item.unit_price" class="form-control" placeholder="$100">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row g-3">
                                            <div class="col-sm-8">
                                                <div class="mb-4">
                                                    ...
                                                    <input type="text" :value="item.gst_code" class="form-control" placeholder="GST Free">
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                <div class="mb-4">
                                                    <label class="form-label">Total</label>
                                                    <input type="text" :value="item.hours * item.unit_price" class="form-control" placeholder="$100">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
